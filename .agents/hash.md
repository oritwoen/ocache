...
- **Type-tagged branches.** Examples include `'str'`, `1n`, `Set[…]`, `Map{…}`, `Ctor{…}`, and `Uint8Array[…]`. Values of different types must not have the same rendering.
